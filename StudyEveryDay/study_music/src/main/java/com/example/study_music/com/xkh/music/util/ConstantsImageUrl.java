...
import com.example.study_core.util.RandomUtil;
...
//        DebugUtil.error("oneList == null:   " + (oneList == null));
    ...
    // 一张图的随机图
    private static final String[] HOME_ONE_URLS = new String[]{
    ...
    // 六图的随机图
    private static final String[] HOME_SIX_URLS = new String[]{
    ...
    public static String getBigOneImage() {

        return getOneUrl().get(RandomUtil.getRandomInt(12));
    }

    public static String getSmallImage() {

        return getSixUrl().get(RandomUtil.getRandomInt(22));
    }

    public static String[] getSixImage() {

        return new String[]{
                HOME_SIX_URLS[RandomUtil.getRandomInt(22)], HOME_SIX_URLS[RandomUtil.getRandomInt(22)], HOME_SIX_URLS[RandomUtil.getRandomInt(22)]
                , HOME_SIX_URLS[RandomUtil.getRandomInt(22)], HOME_SIX_URLS[RandomUtil.getRandomInt(22)], HOME_SIX_URLS[RandomUtil.getRandomInt(22)]

        };
    }

    public static String[] getTwoImage() {

        return new String[]{
                HOME_SIX_URLS[RandomUtil.getRandomInt(9)], HOME_SIX_URLS[RandomUtil.getRandomInt(9)], HOME_SIX_URLS[RandomUtil.getRandomInt(9)]
        };
    }
