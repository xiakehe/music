...
public class LocalPlayback implements Playback {
    ...
    LocalPlayback(Context mContext, MusicProvider mMusicProvider) {
        this.mContext = mContext;
        this.mMusicProvider = mMusicProvider;
        WifiManager wifiManager = (WifiManager) mContext.getApplicationContext().getSystemService(Context.WIFI_SERVICE);
        mWifiLock = wifiManager != null ? wifiManager.createWifiLock(WifiManager.WIFI_MODE_FULL, "music_lock") : null;
